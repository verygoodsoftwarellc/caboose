...
module Caboose
  class RequestsController < ApplicationController
    ...
    def index
      ...
      requests = Caboose.storage.list_requests(**filter_params, limit: PER_PAGE + 1, offset: @offset)
      @total_count = Caboose.storage.count_requests(**filter_params)
    ...
    def show
      @request = Caboose.storage.find_request(params[:id])
